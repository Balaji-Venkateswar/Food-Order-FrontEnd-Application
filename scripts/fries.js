import {fries} from "../data/fries-options.js";
...
fries.forEach((item) => {
  friesHTML += ` 
    <button class="products friesproducts"
...
document.querySelector('.fries-products-grid').innerHTML = friesHTML;
...
document.querySelectorAll('.friesproducts').
  forEach((button)=>{
