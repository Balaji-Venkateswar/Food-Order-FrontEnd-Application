import {drinks} from "../data/drinks-options.js";
...
drinks.forEach((item) => {
  drinksHTML += ` 
    <button class="products drinksproducts"
...
document.querySelector('.drinks-products-grid').innerHTML = drinksHTML;
...
document.querySelectorAll('.drinksproducts').
  forEach((button)=>{
